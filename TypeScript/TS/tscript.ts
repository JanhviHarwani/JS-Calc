...
for (var i = 0; i < buttonLength; i++) {
  buttons[i].addEventListener("click", function (event) {
    ...
    switch (buttonText) {
      ...
      case "2nd":
        document.querySelector("button.xSquare")!.innerHTML =
          ' <div class="textAlignmentContainer">x<sup>3</sup></div>';
        document.querySelector("button.sqrt")!.innerHTML =
          ' <div class="textAlignmentContainer"><sup>3</sup>√</div>';
        document.querySelector("button.power")!.innerHTML =
          ' <div class="textAlignmentContainer">y√x</div>';
        document.querySelector("button.tenRaiseTo")!.innerHTML =
          ' <div class="textAlignmentContainer">2<sup>x</sup></div>';
        document.querySelector("button.log")!.innerHTML =
          ' <div class="textAlignmentContainer">log<sub>y</sub>x</div>';
        document.querySelector("button.naturalLog")!.innerHTML =
          ' <div class="textAlignmentContainer">e<sup>x</sup></div>';
        break;
